"""Download 3 years of 1-minute OHLCV for NIFTY 100 via Kite Connect."""
...
from data.nifty100 import load_nifty100_symbols  # noqa: E402
from kite_client import authenticate  # noqa: E402

START = datetime(2023, 9, 4, 9, 15, 0)
END = datetime(2026, 9, 4, 15, 30, 0)
RAW_DIR = ROOT / "data" / "raw"
SUMMARY_PATH = RAW_DIR / "nifty100_1min_summary.json"
FAILURES_PATH = RAW_DIR / "nifty100_1min_failures.json"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download NIFTY 100 1-minute candles from Kite.")
...
def print_plan() -> dict:
    ...
    print("NIFTY 100 1-minute download plan")
